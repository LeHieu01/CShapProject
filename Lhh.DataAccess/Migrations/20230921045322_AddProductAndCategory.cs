...
namespace Lhh.DataAccess.Migrations
{
    /// <inheritdoc />
    public partial class AddProductAndCategory : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 9, 21, 11, 53, 20, 361, DateTimeKind.Local).AddTicks(3721), 1, "Action" },
                    { 2, new DateTime(2023, 9, 21, 11, 53, 20, 361, DateTimeKind.Local).AddTicks(3733), 2, "SciFi" },
                    { 3, new DateTime(2023, 9, 21, 11, 53, 20, 361, DateTimeKind.Local).AddTicks(3734), 3, "History" }
                });
